...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "You can reach our support team via email at support@eduguide.online or by filling out the contact form on this page.",
  },
  {
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Whether you have questions about using EduGuide, need help with your
            account, or just want to know more about our services, our support
            team is ready to assist you. Explore our FAQs or get in touch
            directly.
          </p>
        ...
        >
          ...
          <Card className="text-center hover:shadow-lg transition-shadow duration-300">
            ...
            <CardContent>
              <p className="text-gray-600 mb-4">
                ...
                <strong>support@eduguide.online</strong>. We’re here to answer
                your questions and help resolve any issues.
              </p>
              <Link href="mailto:support@eduguide.online">
          ...
          <Card className="text-center hover:shadow-lg transition-shadow duration-300">
            <CardHeader className="pt-6">
              ...
              <CardDescription>
                Connect with fellow students and our team
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600 mb-4">
                Visit our student community forums to find answers, share tips,
                and get advice from others using EduGuide. Check out discussion
                threads or start your own.
              </p>
              <Link href="https://community.eduguide.online">
        ...
        >
          ...
          <p className="text-xl mb-8 opacity-90">
            ...
            with our support team directly. We’re committed to helping you make
            the most of EduGuide.
          </p>
          <Link href="/contact">
