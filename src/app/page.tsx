...
import { GraduationCap, MessageCircle, Search, Users, ArrowRight, Bot, BookOpen, DollarSign, Headphones, Star } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center">
          ...
          >
            Get AI-powered college recommendations based on your GPA, location, and goals. Discover the perfect school from our database of 40+ institutions across the US.
          </motion.p>
        ...
        >
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300 border-l-4 border-green-600">
            ...
            <CardContent>
              <p className="text-gray-600">
                Browse our comprehensive database with detailed info on tuition, acceptance rates, majors, financial aid, and graduation rates. Filter by state, type, and budget.
              </p>
              <Link href="/colleges">
                <Button variant="link" className="mt-2 p-0">Explore colleges &rarr;</Button>
              </Link>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-300 border-l-4 border-purple-600">
            ...
            <CardContent>
              <p className="text-gray-600">
                Get 1-on-1 tutoring, essay review, admissions coaching, and live support from our team of certified educators and college counselors.
              </p>
              <Link href="/services">
                <Button variant="link" className="mt-2 p-0">View services &rarr;</Button>
              </Link>
            </CardContent>
          </Card>
        </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Tell us your GPA, preferred state, intended major, and budget level.
              </p>
            </div>
            <div className="text-center">
              ...
              <Card key={testimonial.name} className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="pt-6">
                  <div className="flex gap-0.5 mb-3">
                    {[1, 2, 3, 4, 5].map(s => (
                      <Star key={s} className={`h-4 w-4 ${s <= testimonial.rating ? "text-yellow-500 fill-current" : "text-gray-300"}`} />
                    ))}
                  </div>
        ...
        >
          ...
          <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
            Join thousands of students who&apos;ve found their ideal college with EduGuide. Start your journey today - it&apos;s free.
          </p>
